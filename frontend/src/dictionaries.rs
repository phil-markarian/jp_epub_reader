                    ...
                    view! {
                        <div class="dict-preview">
                            ...
                            <div class="dict-installed-scroll dict-sources-scroll">
                                <details open=(total_ready > 0) class="dict-sources-section">
                                    <summary>
                                        <strong>{format!(
...
// Icon components moved to crate::icons so the library row can
// share them.
use crate::icons::{RotateRightIcon, TrashIcon};
